...
// "Blank start" variants for live hackathons (hackathons.settings.blank_start_mode)
// — every challenge's instructional comment is byte-identical to the guided
// scaffold above (that's the actual teaching content); only the pre-filled
// ANSWERS are removed, so a participant writes the whole file themselves
// instead of just editing values that already work. config/requirements/
...
# ═══════════════════════════════════════════════
TIME_OF_DAY = ""
# Write your if/elif/else block here (see the example above):
...
#          something totally random and off-topic.
# ═══════════════════════════════════════════════
# Write your function here (see the example above):
...
# ═══════════════════════════════════════════════
TOPIC_KEYWORDS = []
# Write your for-loop here (see the example above):
...
# ═══════════════════════════════════════════════
PHRASE_IDEAS = []
# Write your list comprehension here (see the example above):
...
#          .get() it won't crash, it just uses your fallback text.
# ═══════════════════════════════════════════════
# Write your .get() lookup here (see the example above):
...
# ═══════════════════════════════════════════════
RULE_COUNT = 0
# Write your counting for-loop here (see the example above):
...
export const PROJECT_SCAFFOLDS_BLANK: Record<ProjectType, ProjectScaffold> = {
  chatbot: { ...PROJECT_SCAFFOLDS.chatbot, main: BLANK_CHATBOT_MAIN },
  agent: { ...PROJECT_SCAFFOLDS.agent, main: BLANK_AGENT_MAIN },
};
