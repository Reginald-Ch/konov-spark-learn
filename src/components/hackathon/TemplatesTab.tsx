...
const PROJECT_TYPES: {
...
}[] = [
  {
    ...
    description: 'A complete chatbot template with 4 challenges: give it a personality, teach it knowledge, add follow-up questions, and personalise. Everything works — you just fill in YOUR content!',
    stages: [
